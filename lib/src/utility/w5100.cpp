...
#else
//#define SS_PIN_DEFAULT  10  // originale
#define SS_PIN_DEFAULT  5
#endif
...
uint8_t W5100Class::init(void)
{
	...
	SPI.begin();  // original
	//SPI.begin(18,19,23,5); // for use with esp32
...
uint8_t W5100Class::softReset(void)
{
	...
	//Serial.println("Wiznet soft reset XCXC");
	// write to reset bit
	writeMR(0x80);
...
//    Serial.println("---qui---");
//    char s[200];
//    sprintf(s,"PHYCFGR:%02X",phystatus);
//    Serial.println(s);
